...
#initializing the clicks in master and slave
mastercount=0
slavecount=0
...
#function to solve the constant coefficients
def solve():
	global order
	global abca, defa  #single dimension array to store the constant coefficients
	#algorithm to solve 2nd order transformation
	if order==2:
		...
		print defa
	#algorithm to solve 1st order transformation
	if order==1:
		#def linsolve():
		...
		X1=(arr[0][0])*abca[0]+()()
	#algorithm to solve 3rd order transformation	   
	if order==3: 
		#def cubicsolve():
		print clicks
		arr=clicks[:]
...
#function returning the value of keyx (used in slave image select points)
def valueofkey():
    global keyx
    return keyx
#function to set keyx
def setkeyx():
    global keyx    
    keyx=True    
#function to reset keyx
def resetkeyx():
    global keyx    
    keyx=False 
...
global keyy
keyy=False
#function to return the value of keyy(used in master select points)
def valueofkey1():
    global keyy
    return keyy
...
keyyx=False    
#function to return the value of keyyx(used in 'point show' button)
def valueofkey2():
	global keyyx
	return keyyx
#function to set keyy
def setkeyy():
    global keyy
    keyy=True   
#function to reset keyy
def resetkeyy():
    global keyy    
    keyy=False   
#function to reset keyyx
def resetkeyyx():
    global keyyx    
    keyyx=False   
